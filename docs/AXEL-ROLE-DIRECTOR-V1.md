...
- MusicXML: Afri-Can Reunion, Flying Circus, On her way home, 3 anges pour une fretless
...
| --- | --- | --- |
| Violin 1 | Melody crown | Chord tones 1/3/5 or characteristic 9/13; #11 only when the quality asks for it |
...
Exports (`buildMidiExportNotes`) call `orchestrateSequence()` so every written part sees N→N+1.
