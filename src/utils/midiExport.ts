...
export function generateMidiFile(measures: SequenceMeasure[], tempo: number): Uint8Array {
...
export function downloadMidiFile(measures: SequenceMeasure[], tempo: number): void {
  const bytes = generateMidiFile(measures, tempo);
